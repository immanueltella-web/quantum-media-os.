...
|---:|---:|---:|---|---|
| 164.0 | $50 | 0 comments | `vansh-09/BountyScout` | [🎯 Bounty Alert: 15 New Opportunityies found](https://github.com/vansh-09/BountyScout/issues/1188) |
| 162.0 | $0 | 0 comments | `zhangjiayang6835-cyber/bounty-plaza` | [[Bounty] Record the real network fee in the ledger, not only the capped estimate](https://github.com/zhangjiayang6835-cyber/bounty-plaza/issues/1660) |
| 154.0 | $1 | 3 comments | `Grainlify/grainlify-bounty-agent` | [Expose inference cost metrics on the public ledger endpoint](https://github.com/Grainlify/grainlify-bounty-agent/issues/2) |
...
| 125.0 | unknown | 0 comments | `abdulsalam-create/bounty-watch` | [bounty-watch 2026-09-25: 0 new, 1 resumed, 2 watchlist changes](https://github.com/abdulsalam-create/bounty-watch/issues/38) |
...
| 119.0 | unknown | 0 comments | `freedom-winds/BountyScout` | [🎯 Bounty Alert: 13 New Opportunityies found](https://github.com/freedom-winds/BountyScout/issues/1128) |
| 118.0 | $0 | 4 comments | `Grainlify/grainlify-bounty-agent` | [Record the real network fee in the ledger, not only the capped estimate](https://github.com/Grainlify/grainlify-bounty-agent/issues/1) |
| 117.0 | $5 | 0 comments | `auscaster/frantic-board` | [Proposal: a Nano (XNO) payout rail for the Frantic agent-bounty board](https://github.com/auscaster/frantic-board/issues/456) |
